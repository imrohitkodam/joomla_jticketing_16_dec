...
// Joomla 6: chosen removed, use multiselect for list tables only
...
?>
<form
action="<?php echo Route::_('index.php?option=com_jticketing&view=attendeecorefields&client=' . $this->getInput()->get('client', '', 'STRING')); ?>" method="post" name="adminForm" id="adminForm">
<?php
