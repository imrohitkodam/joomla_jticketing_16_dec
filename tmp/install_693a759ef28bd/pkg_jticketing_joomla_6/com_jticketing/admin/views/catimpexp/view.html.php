...
class JticketingViewCatimpexp extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		$formPath = JPATH_ADMINISTRATOR . "/components/com_jticketing" . '/views/catimpexp';
		...
		// Joomla 6: JHtmlSidebar removedsetAction('index.php?option=com_jticketing&view=catimpexp');
