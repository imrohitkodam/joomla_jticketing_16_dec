...
class JticketingViewReminders extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		require_once (defined('JPATH_ADMINISTRATOR') ? JPATH_ADMINISTRATOR : JPATH_SITE) . '/components/com_jticketing . '/helpers/jticketing.php';
		...
		$formPath = JPATH_ADMINISTRATOR . "/components/com_jticketing" . '/views/reminder';
		...
		// Joomla 6: JHtmlSidebar removedsetAction('index.php?option=com_jticketing&view=reminders');

		$this->extra_sidebar = '';

			// Joomla 6: JHtmlSidebar removedaddFilter(
