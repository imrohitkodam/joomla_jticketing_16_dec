...
if (file_exists(JPATH_SITE . '/libraries/techjoomla/tjnotifications/tjnotifications.php'))
{
	require_once JPATH_SITE . '/libraries/techjoomla/tjnotifications/tjnotifications.php';
}
...
class JticketingModelpayment extends BaseDatabaseModel
{
	...
	public function __construct()
	{
		...
		if (!class_exists('TjGeoHelper') && file_exists($TjGeoHelper))
		{
		...
		if (!class_exists('JticketingOrdersHelper') && file_exists($jTOrderHelper))
		{
			require_once $jTOrderHelper;
		}
	...
	{
		// Joomla 6: JLoader removed - payment model is already loaded
	...
	{
		// Joomla 6: JLoader removed - mail helper loaded if needed
	...
	public function updateOrderEvent($id, $data, $member_id)
	{
		...
		// Joomla 6: JLoader removed - event helper loaded if needed
		if (!class_exists('jteventHelper') && file_exists(JPATH_SITE . '/components/com_jticketing/helpers/event.php'))
		{
