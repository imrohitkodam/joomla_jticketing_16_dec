...
// Joomla 6: CMSObject replaced with stdClass
...
class JticketingViewCoupons extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->addToolbar();
		// Joomla 6: JHtmlSidebar removed - sidebar handled by menu system
		// render() removed, sidebar functionality handled by menu system
		$this->sidebar = '';
