...
class JticketingHelper
{
	...
	public static function addSubmenu()
	{
		if (JVERSION < '4.0.0')
		{
			...
			// Joomla 6: Sidebar removed, using menu system instead
			// Sidebar functionality is now handled by Joomla's menu system
		}
	}
	...
	public static function getSubusers($userId = null)
	{
		...
		if (!isset($subusers[$userId]))
		{
			...
			{
				if (file_exists(JPATH_ADMINISTRATOR . '/components/com_hierarchy/models/hierarchy.php'))
				{
					require_once JPATH_ADMINISTRATOR . '/components/com_hierarchy/models/hierarchy.php';
