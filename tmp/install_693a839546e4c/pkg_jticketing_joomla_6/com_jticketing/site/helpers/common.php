...
// Joomla 6: JLoader removed, using require_once instead
if (file_exists(JPATH_SITE . '/components/com_jticketing/helpers/route.php'))
{
	require_once JPATH_SITE . '/components/com_jticketing/helpers/route.php';
}
if (file_exists(JPATH_SITE . '/components/com_jticketing/events/order.php'))
{
	require_once JPATH_SITE . '/components/com_jticketing/events/order.php';
}
if (file_exists(JPATH_SITE . '/components/com_jticketing/models/tickettype.php'))
{
	require_once JPATH_SITE . '/components/com_jticketing/models/tickettype.php';
}
if (file_exists(JPATH_SITE . '/components/com_jticketing/helpers/main.php'))
{
	require_once JPATH_SITE . '/components/com_jticketing/helpers/main.php';
}
if (file_exists(JPATH_SITE . '/components/com_jticketing/models/enrollment.php'))
{
	require_once JPATH_SITE . '/components/com_jticketing/models/enrollment.php';
}
...
class JticketingCommonHelper
{
	...
	public function createFreeTicket($userID, $orderID, $flag = 0)
	{
		...
		// Joomla 6: JLoader removed - load mail helper if needed
		if (!class_exists('JticketingMailHelper') && file_exists(JPATH_SITE . '/components/com_jticketing/helpers/mail.php'))
		{
			require_once JPATH_SITE . '/components/com_jticketing/helpers/mail.php';
		}
		...
		if ($order['order_info']['0']->amount == 0 || $flag == 1)
		{
			...
			{
				// Joomla 6: JLoader removed - load payment model if needed
				$paymentHelper = JPATH_SITE . '/components/com_jticketing/models/payment.php';
				if (file_exists($paymentHelper))
				{
					require_once $paymentHelper;
				}
			}
			...
			if ($this->integration == 2)
			{
				...
				{
					// Joomla 6: JLoader removed - load venueform model if needed
					if (!class_exists('JticketingModelVenueForm') && file_exists(JPATH_SITE . '/components/com_jticketing/models/venueform.php'))
					{
