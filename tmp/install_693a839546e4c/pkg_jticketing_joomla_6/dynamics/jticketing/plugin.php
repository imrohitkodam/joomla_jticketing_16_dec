...
class plgAcymJticketing extends acymPlugin
{
    ...
    public function replaceIndividualContent($tag)
    {
        ...
        $itemId = $utilities->getItemId($link, 0, $element->catid);
        ...
        $startdate = $utilities->getFormatedDate($element->startdate);
        $varFields['{startdate}'] = $startdate;

        $enddate = $utilities->getFormatedDate($element->enddate);
        ...
        $varFields['{intro}'] = $this->cleanDivTags($element->long_description);
